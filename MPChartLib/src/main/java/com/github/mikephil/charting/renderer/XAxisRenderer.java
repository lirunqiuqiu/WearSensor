...
public class XAxisRenderer extends AxisRenderer {
     ...
     * @param c
     */
    public void renderScaleLines(Canvas c,boolean longScale) {
        ...
        for (int i = 0; i < positions.length - 2; i += 2) {
            ...
            drawScale(c, positions[i], offset, longScale);
        }
    }
     ...
     * 绘制线
     */
    protected void drawScale(Canvas canvas, float startX, float offset,boolean longScale) {
